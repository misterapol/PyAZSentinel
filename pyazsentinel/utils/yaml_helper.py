...
class YAMLHelper:
    """Helper class for YAML import/export operations."""
    ...
    def parse_alert_rules(data: Dict[str, Any]) -> AlertRuleCollection:
        """
        Parse alert rules from YAML data.

        Args:
            data: YAML data containing alert rules
    ...
    def parse_single_alert_rule(data: Dict[str, Any]) -> AlertRuleCollection:
        """
        Parse a single alert rule from YAML data and wrap it in a collection.

        Args:
            data: YAML data containing a single alert rule
    ...
    def parse_hunting_rules(data: Dict[str, Any]) -> HuntingRuleCollection:
        """
        Parse hunting rules from YAML data.

        Args:
            data: YAML data containing hunting rules
    ...
    def parse_data_connectors(data: Dict[str, Any]) -> DataConnectorCollection:
        """
        Parse data connectors from YAML data.

        Args:
            data: YAML data containing data connectors
